...
class Slots {
  Slots({
    ...
    _doctorId = doctorId;
    _time = time;
    _endTime = endTime ?? '0000';
    _slotDuration = slotDuration;
    _slotsTimeJson = slotsTimeJson;
    _weekday = weekday;
  ...
  Slots.fromJson(dynamic json) {
    ...
    _doctorId = json['doctor_id'];
    _time = json['time'];
    _endTime = json['end_time'] ?? "0000";
    _slotDuration = json['slot_duration'];
    _slotsTimeJson = json['slots_time_json'];
  ...
  Slots copyWith({
    ...
    String? updatedAt,
      ...
      Slots(
        ...
        slotsTimeJson: slotsTimeJson ?? _slotsTimeJson,
  ...
  String? get slotsTimeJson => _slotsTimeJson;
